...
For detecting the circles in the image we will use the following parameters (from [OpenCV HoughCircles](http://docs.opencv.org/3.0-beta/modules/imgproc/doc/feature_detection.html#houghcircles)):
